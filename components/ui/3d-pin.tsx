    ...
    >
      ...
      >
        <div
          ...
          className="bento-card absolute left-1/2 p-4 top-1/2 w-72 sm:w-88 lg:w-120 flex justify-start items-start rounded-2xl border dark:border-white/10 border-black/10 transition duration-700 overflow-hidden"
        >
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full dark:bg-zinc-950 bg-white py-0.5 px-4 ring-1 dark:ring-white/10 ring-black/10 "
          >
